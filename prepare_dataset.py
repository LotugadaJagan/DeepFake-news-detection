...
SAMPLE_FAKE_PATH = 'dataset/Fake_sample.csv'
SAMPLE_TRUE_PATH = 'dataset/True_sample.csv'

# Ensure the dataset directory exists
os.makedirs('dataset', exist_ok=True)

# Create a smaller sample dataset for faster training
print("Creating smaller sample dataset for training...")
...
# Create balanced samples (5000 from each)
sample_size = 5000
...
print(f"Sample datasets saved to {SAMPLE_FAKE_PATH} and {SAMPLE_TRUE_PATH}")